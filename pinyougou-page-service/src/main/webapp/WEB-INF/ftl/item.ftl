					...
					<div class="clearfix choose">
						...
						<#list specificationList as specification>
							<dl>
								...
								ng-click="selectSpecification('${specification.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span>
</a></dd>
								</#list>
							</dl>
						</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" class="sui-btn  btn-danger addshopcar" ng-click="add2Cart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
